...
export function MobileFilePreview({
    ...
    if (file.type === "image") {
      return (
        <div className="flex flex-col items-center justify-center h-full">
          <div className="relative overflow-auto max-h-[50vh] flex items-center justify-center">
            <img
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="p-0 gap-0 max-w-full h-[100vh] flex flex-col">
        ...
        <div className="flex justify-between items-center p-4 border-t">
          ...
          <div className="flex space-x-2">
            <Button variant="outline" size="icon" onClick={() => window.alert("分享功能尚未实现")}>
              <Share2 className="h-4 w-4" />
            </Button>
            <Button variant="outline" size="icon" onClick={() => window.alert("下载功能尚未实现")}>
